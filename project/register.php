      ...
      <div class="col-12 col-sm-8 col-md-4 m-auto">
        <div class="card">
          <div class="card-body" style="height: 450px;">
            ...
            <form action="registerQuery.php" method="post" id="register-confirm">
              ...
              <input type="password" name="password-confirm" id="password-confirm" class="form-control my-3 py-2"
                placeholder="password-confirm" style="opacity: 0.5;">
              ...
              <div class="text-center mt-2">
                ...
                <a href="intro.php" style="text-decoration:none; font-size:12px; color:darkgray">로그인 하기</a>
              </div>
            </form>
          </div>
        </div>
